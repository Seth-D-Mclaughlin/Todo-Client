import { List, Table, Button, Form, FormGroup, Lable, Input, Modal, ModalHeader, ModalBody } from "reactstrap";
...
const TodoEdit = (props) => {
  ...
  const todoUpdate = (event, workout) => {
    event.preventDefault();
    fetch(`http://localhost:3001/task/${props.todoUpdate.id}`, {
      method: 'PUT',
      body: JSON.stringify({task:{title: editTitle, notes: editNotes}}),
      headers: {
